...
def parse_arguments():
  ...
  arg_parser.add_argument('-clean', required = False, action = 'store_true', help = 'Clean simulation files')
  ...
  if args.clean:
    ...
    os.system('rm -rf *.diag *.err xrun.history cov_work xcelium.d .simvision .shadow *.log *.key waves.shm *~')
...
def set_env_variables():
  os.environ['MDV_XLM_HOME'] = '/opt/cadence/installs/XCELIUM2409'
  set_project_root()
